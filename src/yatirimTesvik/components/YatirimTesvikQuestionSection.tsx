...
interface YatirimTesvikQuestionSectionProps {
  title: string;
  description?: string;
  children: ReactNode;
}

export default function YatirimTesvikQuestionSection({ title, description, children }: YatirimTesvikQuestionSectionProps) {
  return (
